#!/bin/bash
#BSUB -J gssl_down_pfp
#BSUB -o logs/downstream_ssl_pfp_%J.out
#BSUB -e logs/downstream_ssl_pfp_%J.err
#BSUB -q gpua10
...
#BSUB -N 
#
# Downstream Evaluation: Self-Supervised PFP (Path Feature Prediction)
# Runs only multiclass link prediction downstream task
# Submit: bsub < scripts/hpc/downstream/downstream_ssl_pfp.sh
#

echo "Starting Downstream Evaluation: Self-Supervised PFP"
echo "=============================================="
