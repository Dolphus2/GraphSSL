#!/bin/bash
#BSUB -J gssl_down_mse
#BSUB -o logs/downstream_ssl_node_mse_%J.out
#BSUB -e logs/downstream_ssl_node_mse_%J.err
#BSUB -q gpua100
...
#BSUB -N 
#
# Downstream Evaluation: Self-Supervised Node Reconstruction (MSE)
# Runs only multiclass link prediction downstream task
# Submit: bsub < scripts/hpc/downstream/downstream_ssl_node_mse.sh
#

echo "Starting Downstream Evaluation: Self-Supervised Node Reconstruction (MSE)"
echo "=============================================="
